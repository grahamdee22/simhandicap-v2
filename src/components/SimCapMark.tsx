...
type Props = {
  /** Square edge length in px/dp. */
  size?: number;
  style?: StyleProp<ViewStyle>;
};

/**
 * Sim Cap robot glyph only (matches hero lockup), for nav headers / small slots.
 */
export function SimCapMark({ size = 28, style }: Props) {
  return (
    <View
      style={[{ width: size, height: size }, style]}
      accessibilityRole="image"
      accessibilityLabel="Sim Cap"
    >
      <Svg width={size} height={size} viewBox="14 18 64 100" preserveAspectRatio="xMidYMid meet">
