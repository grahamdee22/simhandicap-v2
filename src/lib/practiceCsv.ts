/**
 * Practice Analyzer CSV parsing (Phase 1: GSPro).
 * Pure TypeScript — no React Native / Deno / Node APIs so the same logic can
 * run in unit tests and be copied into supabase/functions/_shared/practiceCsv.ts.
 *
